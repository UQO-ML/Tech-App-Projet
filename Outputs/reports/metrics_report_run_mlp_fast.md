...
- Score de sélection: `0.4807`
- F1 macro test du meilleur: `0.5911`
- Échantillons: `24783`
...
- model_grid_overrides: `{'MLPClassifier': {'svd__n_components': [20, 40], 'clf__hidden_layer_sizes': [[128]], 'clf__alpha': [0.0001, 0.001], 'clf__learning_rate_init': [0.001]}}`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| MLPClassifier | trained | 0.4807 | 0.5876 | 0.5890 | 0.5911 | 0.5802 ± 0.0070 | 0.0839 | 0.1399 | 0.0300 |  |
