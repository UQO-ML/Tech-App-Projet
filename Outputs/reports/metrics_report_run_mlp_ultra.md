...
- Score de sélection: `0.5385`
- F1 macro test du meilleur: `0.6492`
- Échantillons: `24783`
...
- model_grid_overrides: `{'MLPClassifier': {'svd__n_components': [40, 80, 120], 'clf__hidden_layer_sizes': [[256, 128], [256, 256], [512, 256]], 'clf__alpha': [1e-06, 1e-05, 0.0001, 0.0005], 'clf__learning_rate_init': [0.001, 0.0008, 0.0005, 0.0002]}}`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| MLPClassifier | trained | 0.5385 | 0.6319 | 0.6238 | 0.6492 | 0.6430 ± 0.0062 | 0.1678 | 0.2520 | 0.0300 |  |
