...
## Résumé global
- Modèle retenu: `LogisticRegressionGPU`
- Score de sélection: `0.4877`
- F1 macro test du meilleur: `0.5958`
- Échantillons: `24783`
...
- skipped: `0`
- failed: `0`
- modèles attendus: `['LogisticRegressionGPU']`
- modèles entraînés: `['LogisticRegressionGPU']`
...
- algorithm_switches: `{'NaiveBayes': False, 'LogisticRegression': False, 'LinearSVC': False, 'KNN': False, 'DecisionTree': False, 'RandomForest': False, 'AdaBoost': False, 'MLPClassifier': False, 'LogisticRegressionGPU': True, 'LinearSVCGPU': False, 'KNNGPU': False, 'RandomForestGPU': False, 'DistilBERT': False}`
- test_size: `0.2`
- val_size: `0.1`
- cv_folds: `5`
- scoring: `f1_macro`
- model_param_overrides: `{}`
- model_grid_overrides: `{'LogisticRegressionGPU': {'svd__n_components': [64], 'clf__C': [1.0]}}`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| LogisticRegressionGPU | trained | 0.4877 | 0.5937 | 0.5912 | 0.5958 | 0.5983 ± 0.0052 | 0.0769 | 0.1333 | 0.0300 |  |
