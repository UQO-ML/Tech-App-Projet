...
- Score de sélection: `0.4555`
- F1 macro test du meilleur: `0.5409`
- Échantillons: `24783`
...
- model_grid_overrides: `{'AdaBoost': {'clf__n_estimators': [400, 800, 1200], 'clf__learning_rate': [0.01, 0.03, 0.1, 0.3], 'clf__estimator__max_depth': [1, 2, 3, 4], 'clf__estimator__min_samples_leaf': [1, 2, 4]}}`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| AdaBoost | trained | 0.4555 | 0.6200 | 0.5615 | 0.5409 | 0.5418 ± 0.0117 | 0.1364 | 0.1955 | 0.0300 |  |
