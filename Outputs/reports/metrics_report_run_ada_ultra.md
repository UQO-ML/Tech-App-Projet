...
- Score de sélection: `0.4958`
- F1 macro test du meilleur: `0.5864`
- Échantillons: `24783`
...
- model_grid_overrides: `{'AdaBoost': {'clf__n_estimators': [800, 1200, 1600], 'clf__learning_rate': [0.01, 0.03, 0.1, 0.3, 0.6], 'clf__estimator__max_depth': [2, 3, 4, 5], 'clf__estimator__min_samples_leaf': [1, 2, 4, 8]}}`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| AdaBoost | trained | 0.4958 | 0.6530 | 0.5829 | 0.5864 | 0.5994 ± 0.0072 | 0.1748 | 0.2160 | 0.0300 |  |
