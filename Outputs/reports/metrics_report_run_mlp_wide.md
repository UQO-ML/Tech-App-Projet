...
- Score de sélection: `0.5302`
- F1 macro test du meilleur: `0.6339`
- Échantillons: `24783`
...
- model_grid_overrides: `{'MLPClassifier': {'svd__n_components': [20, 40, 60, 80], 'clf__hidden_layer_sizes': [[128], [256, 128], [256, 256]], 'clf__alpha': [1e-05, 0.0001, 0.0005, 0.001], 'clf__learning_rate_init': [0.001, 0.0007, 0.0005, 0.0003]}}`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| MLPClassifier | trained | 0.5302 | 0.6261 | 0.6291 | 0.6339 | 0.6354 ± 0.0125 | 0.1469 | 0.2211 | 0.0300 |  |
