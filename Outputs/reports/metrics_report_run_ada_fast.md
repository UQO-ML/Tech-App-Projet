...
- Score de sélection: `0.3035`
- F1 macro test du meilleur: `0.3898`
- Échantillons: `24783`
...
- model_grid_overrides: `{'AdaBoost': {'clf__n_estimators': [200, 400], 'clf__learning_rate': [0.05, 0.1], 'clf__estimator__max_depth': [1, 2], 'clf__estimator__min_samples_leaf': [1, 2]}}`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| AdaBoost | trained | 0.3035 | 0.5160 | 0.3919 | 0.3898 | 0.3900 ± 0.0036 | 0.0105 | 0.0198 | 0.0300 |  |
