...
## Résumé global
- Modèle retenu: `RandomForestGPU`
- Score de sélection: `0.4154`
- F1 macro test du meilleur: `0.5153`
- Échantillons: `24783`
...
- skipped: `0`
- failed: `0`
- modèles attendus: `['RandomForestGPU']`
- modèles entraînés: `['RandomForestGPU']`
...
- algorithm_switches: `{'NaiveBayes': False, 'LogisticRegression': False, 'LinearSVC': False, 'KNN': False, 'DecisionTree': False, 'RandomForest': False, 'AdaBoost': False, 'MLPClassifier': False, 'LogisticRegressionGPU': False, 'LinearSVCGPU': False, 'KNNGPU': False, 'RandomForestGPU': True, 'DistilBERT': False}`
- test_size: `0.2`
- val_size: `0.1`
- cv_folds: `5`
- scoring: `f1_macro`
- model_param_overrides: `{}`
- model_grid_overrides: `{'RandomForestGPU': {'svd__n_components': [96, 160, 224], 'clf__n_estimators': [300, 600, 900], 'clf__max_depth': [16, 24, 32], 'clf__max_features': [0.4, 0.6, 0.8, 1.0]}}`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| RandomForestGPU | trained | 0.4154 | 0.4996 | 0.5275 | 0.5153 | 0.5201 ± 0.0095 | 0.0175 | 0.0338 | 0.0300 |  |
