...
- Score de sélection: `0.4088`
- F1 macro test du meilleur: `0.4974`
- Échantillons: `24783`
...
- model_grid_overrides: `{'KNNGPU': {'svd__n_components': [64, 128, 192], 'clf__n_neighbors': [3, 5, 11, 21, 31], 'clf__weights': ['uniform']}}`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| KNNGPU | trained | 0.4088 | 0.5125 | 0.5056 | 0.4974 | 0.5060 ± 0.0147 | 0.0734 | 0.1047 | 0.0300 |  |
