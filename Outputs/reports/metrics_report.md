...
- skipped: `0`
- failed: `0`
- modèles attendus: `['LogisticRegression', 'RandomForest']`
- modèles entraînés: `['LogisticRegression', 'RandomForest']`
...
- algorithm_switches: `{'NaiveBayes': False, 'LogisticRegression': True, 'LinearSVC': False, 'KNN': False, 'DecisionTree': False, 'RandomForest': True, 'AdaBoost': False, 'MLPClassifier': False, 'LogisticRegressionGPU': False, 'LinearSVCGPU': False, 'KNNGPU': False, 'RandomForestGPU': False, 'DistilBERT': False}`
- test_size: `0.2`
- val_size: `0.1`
- cv_folds: `5`
- scoring: `f1_macro`
