...
- Score de sélection: `0.5051`
- F1 macro test du meilleur: `0.6169`
- Échantillons: `24783`
...
- model_grid_overrides: `{'LinearSVCGPU': {'svd__n_components': [64, 128], 'clf__C': [0.5, 1.0, 2.0]}}`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| LinearSVCGPU | trained | 0.5051 | 0.6163 | 0.6087 | 0.6169 | 0.6206 ± 0.0058 | 0.0769 | 0.1346 | 0.0300 |  |
